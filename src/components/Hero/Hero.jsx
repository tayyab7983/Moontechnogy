...
//       {/* Left Glow */}
//       <div className="absolute -top-56 -left-44 w-[700px] h-[700px] rounded-full bg-[#d4af37]/10 blur-[180px]" />

//       {/* Right Glow */}
//       <div className="absolute top-20 right-0 w-[600px] h-[600px] rounded-full bg-[#d4af37]/10 blur-[180px]" />
//               {/* Golden Light */}
// <div className="absolute bottom-20 left-1/2 -translate-x-1/2 w-[500px] h-[250px] rounded-full bg-[#d4af37]/10 blur-[140px]"></div>
//       {/* Noise Overlay */}
...
//        <div className="grid lg:grid-cols-2 min-h-screen items-center gap-10 pt-24">
//           {/* LEFT */}

//           <div>

//             <p className="heroBadge uppercase tracking-[8px] text-[#d4af37] text-sm mb-8">
...
//             <h1 className="heroTitle font-serif text-[65px] md:text-[95px] xl:text-[125px] leading-[0.85] font-semibold">
...
//             <p className="heroText mt-8 max-w-[580px] text-gray-400 text-lg leading-8">

//               We craft premium websites, AI solutions,
//               mobile applications and immersive digital
//               experiences that help brands grow faster.

//             </p>

//             <div className="mt-12 flex flex-wrap gap-5">

//               <button className="heroBtn group px-9 py-4 rounded-full bg-[#d4af37] text-black font-semibold flex items-center gap-3 hover:scale-110 duration-300 shadow-[0_0_35px_rgba(212,175,55,0.35)]"
// >
//                 Explore
...
//               <button className="heroBtn px-9 py-4 rounded-full border border-white/30 backdrop-blur-md hover:border-[#d4af37] hover:text-[#d4af37] duration-300">
//                 Contact Us
...
//          <div className="heroMoon relative h-[700px]">
